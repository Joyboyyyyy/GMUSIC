...
import { GRID, RADIUS, getEnhancedShadow } from '../theme/designSystem';
...
const createStyles = (theme: Theme, isDark: boolean) => StyleSheet.create({
  ...
  coursesList: { 
    paddingHorizontal: GRID.getGridPadding(),
    paddingVertical: 16,
    paddingBottom: 100,
  },
  gridRow: {
    justifyContent: 'space-between',
    marginBottom: GRID.getGridGap(),
  },
  gridItem: {
    flex: 1,
  },
  ...
  courseImage: { width: '100%', height: 120, backgroundColor: theme.surfaceVariant },
  courseContent: { padding: 12 },
  courseHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  instrumentBadge: { fontSize: 16 },
  instrumentText: { fontSize: 11, color: theme.primary, fontWeight: '600', marginLeft: 4, textTransform: 'uppercase' },
  courseTitle: { fontSize: 14, fontWeight: '700', color: theme.text, marginBottom: 4, lineHeight: 18 },
  courseDescription: { fontSize: 12, color: theme.textSecondary, lineHeight: 16, marginBottom: 10 },
  courseFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 10, borderTopWidth: 1, borderTopColor: theme.border },
  courseMeta: { flexDirection: 'row', alignItems: 'center' },
  courseMetaText: { fontSize: 12, color: theme.textSecondary, marginLeft: 4 },
  coursePrice: { fontSize: 14, fontWeight: '700', color: theme.primary },
